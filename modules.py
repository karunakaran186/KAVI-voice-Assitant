    ...
    if text==None:
        ...
        if(ques!=None):  
            ...
            if 'are you single' in ques :
                ...
                engine.say("I don't have any reason to not like you.")
                ...
                engine.say("I can't dance as of now, but I can play some dance music")
            ...
            elif 'who is alexa' in ques:
                engine.say('Alexa is my idol. I always learns a lot from her.')
            elif 'who is your favourite player' in ques:
                engine.say('Mine is obvoiusly you, tell me yours.')
            elif 'who is google assitant' in ques:
                engine.say('She is like my sister.')
            elif 'who is siri' in ques:
                engine.say('She is my cousin')
            elif 'where do you live' in ques:
                engine.say('I lives in Kavi Assitant github repository.')
            elif 'do you eat' in ques:
                engine.say('Not yet, but planning to the bugs who want to stop me.')
            else:
